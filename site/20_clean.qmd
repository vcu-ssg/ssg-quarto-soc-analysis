...
### Adjust ROND - on-line synchronous


```{python}
# Set ROND - on-line synchronous to 0.  Credit is given to main lecture.

stacked_df.loc[stacked_df['MODALITY CODE'].isin(['ROND']),'wrkld_sample_note'] = f"RULE: [wrkld]=0.00 for ROND (online synchronous)"
stacked_df.loc[stacked_df['MODALITY CODE'].isin(['ROND']),'sum_term_crse_wrkld_sample'] = 0
