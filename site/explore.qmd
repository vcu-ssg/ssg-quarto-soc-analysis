...
measures = {'sum_term_crse_crn':'sum','sum_term_crse_crn_students':'sum','sum_term_crse_crn_hours':'sum'}
mnames = ['CRN sum','STDNTS sum','HRS sum']
...
courses_df.columns = ['instructor','CRN','STDNT','HRS']
...
cols =  ['CRN sum','STDNT sum','HRS sum','LEC','LAB','SEM','RES','IND']
